...
// Copyright (c) 2015 The WorldPay developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("worldpay-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("worldpay-smsg-pow"); // Make this thread recognisable
